...
var training_goals = [
    "doing well on the upcoming test",
    "being good at math",
    "improving at math",
    "doing badly on the upcoming test",
    "showing your teacher that you have high math ability",
    "showing your teacher that you try at math"
];
...
var randomization = {
    ...
    goal_conditions: sample([
        {
            prompt_wording:"original",
            goal_wording:"original",
            dependent_measure:"forced-choice"
        },
        {
            prompt_wording:"training",
            goal_wording:"original",
            dependent_measure:"original"
        },
        {
            prompt_wording:"orignal",
            goal_wording:"achieve",
            dependent_measure:"original"
        },
        {
            prompt_wording:"training",
...
n_trials = 2; /*randomization.slider_trials.length +
...
var experiment = {
    ...
    intro: function() {
        ...
        $(".continue").click(function() {
            ...
            experiment.goals(0);//slider_practice_intro();
        });
    },
    ...
    goals: function () {
        $('.bar').css('width', ( (n_trials_completed / n_trials)*100 + "%"));
        $(".err").hide();
        if (randomization.goal_conditions.prompt_wording == "training") {
            $(".goal_prompt_wording").html("Imagine that you are doing practice problems for a test in a math class.");
                randomization.goals= shuffle(training_goals);
        } else {
            $(".goal_prompt_wording").html("Imagine that you are taking a test in a math class.");
            randomization.goals= shuffle(goals);
        }

        if (randomization.goal_conditions.dependent_measure == "forced-choice") {

            if (randomization.goal_conditions.goal_wording == "value") {
                $("#first_choice_prompt").html("Which of these goals, if achieved, would be the most desirable?");
                $("#second_choice_prompt").html("Which of these goals, if achieved, would be the next most desirable?");
                $("#third_choice_prompt").html("Which of these goals, if achieved, would be the third most desirable?");
            } else if (randomization.goal_conditions.goal_wording == "achieve") {
                $("#first_choice_prompt").html("Which of these goals would you be the most likely to achieve?");
                $("#second_choice_prompt").html("Which of these goals would you be the next most likely to achieve?");
                $("#third_choice_prompt").html("Which of these goals would you be the third most likely to achieve?");
            } else {
                $("#first_choice_prompt").html("Which of these goals would you be the most likely to have?");
                $("#second_choice_prompt").html("Which of these goals would you be the next most likely to have?");
                $("#third_choice_prompt").html("Which of these goals would you be the third most likely to have?");
            }
            ...
            for (var i = 0; i<randomization.goals.length; i++) {
                console.log(i);
                console.log(randomization.goals[i]);
                options += "<option>" + randomization.goals[i] + "</option>";
            }
            $("#first_choice").html(options);
            $("#second_choice").html(options);
            $("#third_choice").html(options);

            showSlide("forced_goals");
            ...
            $(".continue").click(function() {
                ...
                if (first != "" && second != "" && third != "") {
                    ...
                    n_trials_completed++;
                    experiment.data["goals_responses"] = [first, second, third];
            ...
            if (randomization.goal_conditions.goal_wording == "achieve") {
                $(".prompt").html("How likely is it that you will achieve each of the following goals?");
            } else {
